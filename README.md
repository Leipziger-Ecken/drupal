 ...
 * **Quickfix** - this is important: Rename the folder in web/modules/contrib/date_recur/config/optional from "optional" into "install". This dependency-issue will become fixed prior to the first release candidate. 
